...
class Registrarme : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button3.setOnClickListener {
            ...
            val url: String = "https://registrosappinventor.000webhostapp.com/myBase.php?usuario=${usuario.text.toString()}&contrasena=${contrasena.text.toString()}&nombre=${nombreCompleto.text.toString()}"
